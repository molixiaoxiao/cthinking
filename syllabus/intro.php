...
<div id="outside">
    ...
    <div id="navi">
      <ul id="navi_menu">			    
				<li><a href="../index.php" id="nav1" class="same">首页</a></li>
				<li class = nav0></li>
				<li><a href="#" id="nav2" class="same">教学大纲</a></li>
				<li class = nav0></li>
				<li><a href="../thinking/thinking.php" id="nav3"class="same">计算思维</a></li>
				<li class = nav0></li>
				<li id="selected"><a href="../pages/course.php" id="nav4" class="same">课程课件	</a></li>
				<li class = nav0></li>
				<li><a href="../test/test.php" id="nav5" class="same">自我测试</a></li>
				<li class = nav0></li>
				<li><a href="../qustionaires/s_questionare.html" target="_blank"class="same"  id="nav6">调查问卷</a></li>
				<li class = nav0></li>
				<li><a href="../works/works.php" id="nav7" class="same">优秀作品展示</a></li>
				<li class = nav0></li>
				<li><a href="../board/board.php" id="nav8" class="same">学生答疑</a></li>	
			</ul>	
		</div>
...
1、计算思维应该如何理解<br>
		   ...
		   <br>   
		   <p class="professor"><a href="../home/fengboqin.htm" target="_new" >冯博琴教授简介</a></p>
		  </marquee>
    ...
    <div class="right_top"></div>
	   <div class="innerframe">
          <iframe src="syllabus.htm" name="contentFrame" scrolling="no" frameborder="0" class="frame" id="contentFrame" onload="this.height=Math.max(this.contentWindow.document.body.scrollHeight,this.contentWindow.document.documentElement.scrollHeight)+30;"></iframe>
       </div>
	</div> 
  </div>
  <div class="shadow">
